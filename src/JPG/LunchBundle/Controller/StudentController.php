...
use JPG\LunchBundle\Entity\Student;
use JPG\LunchBundle\Form\StudentType;
...
class StudentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JPGLunchBundle:Student')->findAll();
     ...
     * @Method("POST")
     * @Template("JPGLunchBundle:Student:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JPGLunchBundle:Student')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JPGLunchBundle:Student:edit.html.twig")
     */
